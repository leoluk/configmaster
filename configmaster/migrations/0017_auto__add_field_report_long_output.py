...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.long_output'
        db.add_column(u'configmaster_report', 'long_output',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.long_output'
        db.delete_column(u'configmaster_report', 'long_output')
