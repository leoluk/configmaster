...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.hide_if_successful'
        db.add_column(u'configmaster_task', 'hide_if_successful',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.hide_if_successful'
        db.delete_column(u'configmaster_task', 'hide_if_successful')
