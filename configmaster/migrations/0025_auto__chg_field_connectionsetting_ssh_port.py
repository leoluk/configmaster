...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConnectionSetting.ssh_port'
        db.alter_column(u'configmaster_connectionsetting', 'ssh_port', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ConnectionSetting.ssh_port'
        db.alter_column(u'configmaster_connectionsetting', 'ssh_port', self.gf('django.db.models.fields.IntegerField')(default=0))
