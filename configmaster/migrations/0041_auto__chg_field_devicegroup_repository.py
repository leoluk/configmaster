...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeviceGroup.repository'
        db.alter_column(u'configmaster_devicegroup', 'repository_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configmaster.Repository'], null=True))

    def backwards(self, orm):

        # Changing field 'DeviceGroup.repository'
        db.alter_column(u'configmaster_devicegroup', 'repository_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['configmaster.Repository']))
