...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.version_info'
        db.add_column(u'configmaster_device', 'version_info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.version_info'
        db.delete_column(u'configmaster_device', 'version_info')
