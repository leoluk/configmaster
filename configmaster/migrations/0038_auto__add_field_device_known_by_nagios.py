...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.known_by_nagios'
        db.add_column(u'configmaster_device', 'known_by_nagios',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.known_by_nagios'
        db.delete_column(u'configmaster_device', 'known_by_nagios')
