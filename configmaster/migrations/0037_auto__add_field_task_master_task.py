...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.master_task'
        db.add_column(u'configmaster_task', 'master_task',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configmaster.Task'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.master_task'
        db.delete_column(u'configmaster_task', 'master_task_id')
