...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ConnectionSetting'
        db.create_table(u'configmaster_connectionsetting', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('ssh_port', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'configmaster', ['ConnectionSetting'])


        # Changing field 'DeviceType.access_config'
        db.alter_column(u'configmaster_devicetype', 'access_config_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configmaster.ConnectionSetting'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ConnectionSetting'
        db.delete_table(u'configmaster_connectionsetting')


        # Changing field 'DeviceType.access_config'
        db.alter_column(u'configmaster_devicetype', 'access_config_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configmaster.AccessConfig'], null=True))
    ...
    models = {
        ...
        u'configmaster.devicetype': {
            ...
            'access_config': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['configmaster.ConnectionSetting']", 'null': 'True', 'blank': 'True'}),
            'credential': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['configmaster.Credential']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
