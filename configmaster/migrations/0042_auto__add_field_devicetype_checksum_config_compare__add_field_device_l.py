...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceType.checksum_config_compare'
        db.add_column(u'configmaster_devicetype', 'checksum_config_compare',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Device.last_checksum'
        db.add_column(u'configmaster_device', 'last_checksum',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceType.checksum_config_compare'
        db.delete_column(u'configmaster_devicetype', 'checksum_config_compare')

        # Deleting field 'Device.last_checksum'
        db.delete_column(u'configmaster_device', 'last_checksum')
    ...
    models = {
        ...
        u'configmaster.device': {
            ...
            'last_checksum': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        u'configmaster.devicegroup': {
            ...
            'repository': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['configmaster.Repository']", 'null': 'True', 'blank': 'True'})
        },
        u'configmaster.devicetype': {
            'Meta': {'object_name': 'DeviceType'},
            'alternative_config_compare': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'checksum_config_compare': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
