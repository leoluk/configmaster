...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceType.credential'
        db.add_column(u'configmaster_devicetype', 'credential',
    ...
    def backwards(self, orm):
        # Deleting field 'DeviceType.credential'
        db.delete_column(u'configmaster_devicetype', 'credential_id')
