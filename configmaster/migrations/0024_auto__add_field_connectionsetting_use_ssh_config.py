...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConnectionSetting.use_ssh_config'
        db.add_column(u'configmaster_connectionsetting', 'use_ssh_config',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConnectionSetting.use_ssh_config'
        db.delete_column(u'configmaster_connectionsetting', 'use_ssh_config')
