...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceType.config_filter'
        db.add_column(u'configmaster_devicetype', 'config_filter',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceType.config_filter'
        db.delete_column(u'configmaster_devicetype', 'config_filter')
    ...
    models = {
        ...
        u'configmaster.devicetype': {
            ...
            'config_filter': ('django.db.models.fields.TextField', [], {}),
