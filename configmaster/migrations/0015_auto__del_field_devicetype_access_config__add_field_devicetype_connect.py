...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeviceType.connection_setting'
        db.add_column(u'configmaster_devicetype', 'connection_setting',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configmaster.ConnectionSetting'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DeviceType.connection_setting'
        db.delete_column(u'configmaster_devicetype', 'connection_setting_id')
