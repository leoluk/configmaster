...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.result_url'
        db.add_column(u'configmaster_report', 'result_url',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.result_url'
        db.delete_column(u'configmaster_report', 'result_url')
