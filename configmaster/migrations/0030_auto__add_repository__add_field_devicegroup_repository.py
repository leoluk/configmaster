...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'configmaster_repository', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('path', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'configmaster', ['Repository'])

        # Adding field 'DeviceGroup.repository'
        db.add_column(u'configmaster_devicegroup', 'repository',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['configmaster.Repository']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Repository'
        db.delete_table(u'configmaster_repository')

        # Deleting field 'DeviceGroup.repository'
        db.delete_column(u'configmaster_devicegroup', 'repository_id')
