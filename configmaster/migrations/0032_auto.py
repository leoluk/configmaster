...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field latest_reports on 'Device'
        m2m_table_name = db.shorten_name(u'configmaster_device_latest_reports')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('device', models.ForeignKey(orm[u'configmaster.device'], null=False)),
            ('report', models.ForeignKey(orm[u'configmaster.report'], null=False))
        ))
        db.create_unique(m2m_table_name, ['device_id', 'report_id'])


    def backwards(self, orm):
        # Removing M2M table for field latest_reports on 'Device'
        db.delete_table(db.shorten_name(u'configmaster_device_latest_reports'))
