...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.do_not_use_scp'
        db.add_column(u'configmaster_device', 'do_not_use_scp',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.do_not_use_scp'
        db.delete_column(u'configmaster_device', 'do_not_use_scp')
