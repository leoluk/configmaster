...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.date'
        db.alter_column(u'configmaster_report', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding field 'DeviceType.version_regex'
        db.add_column(u'configmaster_devicetype', 'version_regex',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Report.date'
        db.alter_column(u'configmaster_report', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Deleting field 'DeviceType.version_regex'
        db.delete_column(u'configmaster_devicetype', 'version_regex')
    ...
    models = {
        ...
        u'configmaster.report': {
            ...
            'result_url': ('django.db.models.fields.TextField', [], {}),
