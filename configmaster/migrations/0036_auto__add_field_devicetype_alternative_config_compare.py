...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceType.alternative_config_compare'
        db.add_column(u'configmaster_devicetype', 'alternative_config_compare',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceType.alternative_config_compare'
        db.delete_column(u'configmaster_devicetype', 'alternative_config_compare')
