...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceGroup.default_device_type'
        db.add_column(u'configmaster_devicegroup', 'default_device_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configmaster.DeviceType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceGroup.default_device_type'
        db.delete_column(u'configmaster_devicegroup', 'default_device_type_id')
